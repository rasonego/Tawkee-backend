...
export function createStartHumanAttendanceIntention(
  ...
  return {
    ...
    type: 'LOCAL',
    description:
      'Escalate the conversation to a human agent when the user requests to speak to a person or expresses frustration.',
    preprocessingMessage: 'MANUAL',
    preprocessingText:
      'The user has requested to speak to a human or is clearly dissatisfied. Inform them that the conversation has been transferred and ask them to wait for a human agent to respond.',
    outputHint:
